...
const formSchema = z.object({
  repoName: z
    ...
    .regex(/^[a-zA-Z0-9._-]+$/, "Only alphanumeric characters, hyphens, underscores, and dots are allowed"),
    ...
    if (exportStatus === "completed" && exportRepoUrl) {
      return (
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-muted-foreground text-center">Your project has been exported to GitHub.</p>
    ...
    if (exportStatus === "failed") {
      return (
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-muted-foreground text-center">Something went wrong. Please try again.</p>
          <Button size="sm" variant="outline" className="w-full" onClick={handleResetExport}>
            Retry
          </Button>
        </div>
      ...
      >
        <div className="space-y-4">
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">Export your project to a GitHub repository.</p>
          </div>
