  ...
  return (
    <div className="h-full flex flex-col bg-background">
      <div className="h-8.75 flex items-center border-b bg-sidebar shrink-0">
        ...
        <PreviewSettingsPopover projectId={projectId} initialValues={project?.settings} onSave={restart} />
      </div>
      ...
      <div className="flex-1 min-h-0">
        <Allotment vertical>
          <Allotment.Pane>
            ...
            {previewUrl && <iframe src={previewUrl} className="size-full border-0" title="Preview" />}
          </Allotment.Pane>
