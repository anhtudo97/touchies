...
export const PreviewSettingsPopover = ({ projectId, initialValues, onSave }: PreviewSettingsPopoverProps) => {
  ...
  return (
    <Popover open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild>
        <Button size="sm" variant="ghost" className="h-full rounded-none" title="Preview settings">
            ...
            <form.Field name="devCommand">
              {(field) => (
                <Field>
                  ...
                  />
                  <FieldDescription>Command to start the development server</FieldDescription>
                </Field>
              )}
            </form.Field>
